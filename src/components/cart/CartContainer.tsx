      ...
      <div className="flex flex-col lg:flex-row gap-5">
        <div className="w-full lg:w-8/12 ">
          <div className="grid grid-cols-1  gap-4 w-full">
            {loadingCart &&
              [1, 2, 3, 4].map((item) => {
                return <div key={item} className="skeleton w-full h-32">
                  
                </div>;
              })}
            { cartItems.length === 0  && !loadingCart && (
              <div className="text-center font-bold text-[25px] text-error font-main">
        ...
        <div className="w-full lg:w-4/12">
          <div className="bg-white shadow-md rounded-lg p-5">
            ...
            <div className="mt-5">
              <label htmlFor="paymentMethod" className="pl-3">طريقة الدفع</label>
              <select
                name="paymentMethod"
                id="paymentMethod"
